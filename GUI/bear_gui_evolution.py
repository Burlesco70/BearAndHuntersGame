...
###########
class BearBoard:
    def __init__(self, max_bear_moves, hunter_starts):
        # Start settings
    ...
    def get_hunter_starting_pos(self):
        return self._hunter_starting_pos
    
    def get_winner(self) -> str:
        '''Returns the winner in a string type for display purposes'''
        if (self._board in self.get_bear_ko_positions()):
            return 'HUNTER'
        if (self._bear_moves > self._max_bear_moves):
            return 'BEAR'

    def game_over(self) -> bool:
        if ((self._board in self.get_bear_ko_positions()) or (self._bear_moves > self._max_bear_moves)):
            return True
        else:
            return False  

    def manage_hunter_selection(self, sel):
    ...
    def manage_bear_selection(self,sel):
...
class BearInputs:
    ...
    def max_bear_moves(self):
        ...
        self._max_bear_moves_menu = tkinter.OptionMenu(self._menu_window, self._max_bear_moves_variable, '40', '30', '2')
...
class BearGUI:
    def __init__(self):
        ...
        self._pixel_area_listened = self._main_circle_radius / 4
    ...
    def _on_canvas_clicked(self, event: tkinter.Event) -> None:
        ...
        where they clicked and converts its pixels into position.
        This is the core of the game'''
        _pixel_area_listened = 20
